...
public class MainActivity1 extends AppCompatActivity {
    ...
    private ImageButton buttonCheck, buttonSkip, buttonClear, buttonYellow, buttonBlack, buttonOpen, buttonExit;
    private DrawingView drawingView;
    private int num1, num2, totalQuestions, number_question, count;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView level_img = findViewById(R.id.lvl);
        ...
        if (level != -1) {
            switch (level) {
                case 1:
                    level_img.setImageResource(getResources().getIdentifier("lvl1", "drawable", getPackageName()));
                    break;
                case 2:
                    level_img.setImageResource(getResources().getIdentifier("lvl2", "drawable", getPackageName()));
                    break;
                case 3:
                    level_img.setImageResource(getResources().getIdentifier("lvl3", "drawable", getPackageName()));
                    break;
            }
        }
        // Заполнение первого и второго ряда кружками
        ...
        buttonSkip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity1.this, "Вы пропустили пример", Toast.LENGTH_SHORT).show();
                generateNewExample();
            }
        });
            ...
            public void onClick(View v) {
                ...
                try {
                    if (Double.parseDouble(userAnswer) == result) {
                        score += score_task;
                        Toast.makeText(MainActivity1.this, "Правильно! " + score, Toast.LENGTH_SHORT).show();
                        updateCircle(true);
                        count_true++;
                    } else {
                        Toast.makeText(MainActivity1.this, "Неправильно! " + score, Toast.LENGTH_SHORT).show();
                        updateCircle(false);
                    }
                } catch (NumberFormatException e) {
                    Toast.makeText(MainActivity1.this, "Введите корректное число!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (number_question >= totalQuestions) {
                    ...
                    intent.putExtra("count_true", count_true);
        ...
        buttonOpen = findViewById(R.id.draw);
        buttonExit = findViewById(R.id.button_open);

        buttonClear.setOnClickListener(v -> drawingView.clearCanvas());
        buttonYellow.setOnClickListener(v -> drawingView.setColorYellow());
        buttonBlack.setOnClickListener(v -> drawingView.setColorBlack());
        drawingView.setVisibility(View.GONE);
        buttonClear.setVisibility(View.GONE);
        buttonYellow.setVisibility(View.GONE);
